                ...
                const college = [
                    ...
                    for (var i = 0; i <college.length && !priceFound; i++) {
                        ...
                        if (isInRange(marks, value)) {
                            document.getElementById("result").innerHTML ="Predicted College:" + "<br/>"+"<br/>"+ marks.name + "<br/>" + "USA";
                            priceFound = true
                        }
                    }}
                    else{
...
function dynamic(){
    ...
    for(i = 0; i < ele.length; i++) {
        ...
        if (ele[i].checked){
            if (val === "bachelor"){
                document.getElementById("next").href = "bachelors.html";
            }
            if (val === "master"){
                document.getElementById("next").href = "masters.html";
            }
        }
    }
}
